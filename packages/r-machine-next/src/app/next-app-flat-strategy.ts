...
> extends NextAppFlatStrategyCore<RA, L, FP, NextAppFlatStrategyConfig<PAP, LK>> {
  constructor(rMachine: RMachine<RA, L, FP>);
  constructor(rMachine: RMachine<RA, L, FP>, config: PartialNextAppFlatStrategyConfig<PAP, LK>);
  constructor(rMachine: RMachine<RA, L, FP>, config: PartialNextAppFlatStrategyConfig<PAP, LK> = {}) {
    super(rMachine, {

...
> extends NextAppPathStrategyCore<RA, L, E, NextAppPathStrategyConfig<PA, LK>> {
  constructor(rMachine: RMachine<RA, L, E>);
  constructor(rMachine: RMachine<RA, L, E>, config: PartialNextAppPathStrategyConfig<PA, LK>);
  constructor(rMachine: RMachine<RA, L, E>, config: PartialNextAppPathStrategyConfig<PA, LK> = {}) {
    super(rMachine, {

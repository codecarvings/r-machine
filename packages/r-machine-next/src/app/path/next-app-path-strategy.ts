...
> extends NextAppPathStrategyCore<RA, L, E, EF, NextAppPathStrategyConfig<PA, LK>> {
  constructor(rMachine: RMachine<RA, L, E, EF>);
  constructor(rMachine: RMachine<RA, L, E, EF>, config: PartialNextAppPathStrategyConfig<PA, LK>);
  constructor(rMachine: RMachine<RA, L, E, EF>, config: PartialNextAppPathStrategyConfig<PA, LK> = {}) {
    super(rMachine, {

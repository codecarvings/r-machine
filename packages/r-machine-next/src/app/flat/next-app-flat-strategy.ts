...
> extends NextAppFlatStrategyCore<RA, L, E, EF, NextAppFlatStrategyConfig<PA, LK>> {
  constructor(rMachine: RMachine<RA, L, E, EF>);
  constructor(rMachine: RMachine<RA, L, E, EF>, config: PartialNextAppFlatStrategyConfig<PA, LK>);
  constructor(rMachine: RMachine<RA, L, E, EF>, config: PartialNextAppFlatStrategyConfig<PA, LK> = {}) {
    super(rMachine, {

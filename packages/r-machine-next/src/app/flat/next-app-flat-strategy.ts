...
> extends NextAppFlatStrategyCore<RA, L, E, NextAppFlatStrategyConfig<PA, LK>> {
  constructor(rMachine: RMachine<RA, L, E>);
  constructor(rMachine: RMachine<RA, L, E>, config: PartialNextAppFlatStrategyConfig<PA, LK>);
  constructor(rMachine: RMachine<RA, L, E>, config: PartialNextAppFlatStrategyConfig<PA, LK> = {}) {
    super(rMachine, {

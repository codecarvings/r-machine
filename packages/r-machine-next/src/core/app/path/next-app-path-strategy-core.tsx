...
export interface NextAppPathStrategyConfig<PAD extends AnyPathAtlasDeclaration, LK extends string>
...
export interface PartialNextAppPathStrategyConfig<PAD extends AnyPathAtlasDeclaration, LK extends string>

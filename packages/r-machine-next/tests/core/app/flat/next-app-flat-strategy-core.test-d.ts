...
describe("NextAppFlatStrategyCore", () => {
  ...
  it("rMachine is RMachine<RA>", () => {
    expectTypeOf<NextAppFlatStrategyCore<TestAtlas, SimpleConfig>["rMachine"]>().toEqualTypeOf<RMachine<TestAtlas>>();
  });

  it("config preserves the concrete config type parameter", () => {
    expectTypeOf<NextAppFlatStrategyCore<TestAtlas, SimpleConfig>["config"]>().toEqualTypeOf<SimpleConfig>();
  });
  ...
  describe("hrefHelper", () => {
    it("has readonly getPath property", () => {
      type Helper = NextAppFlatStrategyCore<TestAtlas, SimpleConfig>["hrefHelper"];
    ...
    it("getPath is a function that returns string", () => {
      type GetPath = NextAppFlatStrategyCore<TestAtlas, SimpleConfig>["hrefHelper"]["getPath"];
  ...
  it("is abstract and cannot be instantiated directly", () => {
    type Ctor = abstract new (...args: any[]) => NextAppFlatStrategyCore<any, any>;
  ...
  it("different atlas types produce different core types", () => {
    ...
    expectTypeOf<NextAppFlatStrategyCore<TestAtlas, SimpleConfig>>().not.toEqualTypeOf<
      NextAppFlatStrategyCore<OtherAtlas, SimpleConfig>
    >();
  });
  ...
  it("different config types produce different core types", () => {
    ...
    expectTypeOf<NextAppFlatStrategyCore<TestAtlas, SimpleConfig>>().not.toEqualTypeOf<
      NextAppFlatStrategyCore<TestAtlas, OtherConfig>
    >();
  });
});

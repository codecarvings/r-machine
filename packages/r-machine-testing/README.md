⚠️ **WARNING: THIS PACKAGE IS STILL IN ACTIVE DEVELOPMENT - API MAY CHANGE BEFORE STABLE RELEASE** ⚠️
...
| _This package_ | **[`@r-machine/testing`](https://www.npmjs.com/package/@r-machine/testing)** | **`mockPlug` and `verifyResourceAtlas`. A dev dependency, and the recommended way to test resources.** _Warning: this package is still in active development — the API may change before the stable release._ |

  ...
  defineProject({
    ...
    resolve: {
      ...
      alias: [
        ...
        {
          find: /^#r-machine\/testing\/errors$/,
          replacement: path.resolve(import.meta.dirname, "./src/errors/index.ts"),
        },
        { find: /^#r-machine\/testing$/, replacement: path.resolve(import.meta.dirname, "./src/lib/index.ts") },
        ...
        {
          find: /^#r-machine\/core$/,
          replacement: path.resolve(import.meta.dirname, "../r-machine/src/core/index.ts"),
        },
        {
        ...
        },
        {
          ...
          replacement: path.resolve(import.meta.dirname, "../r-machine/src/strategy/web/index.ts"),
        },
        {

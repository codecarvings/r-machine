...
export type GearNamespaceMap<RA extends AnyResAtlas> = {
  readonly [k: string]: GearNamespaceRef<RA>;
};

export type ShellNamespaceMap<RA extends AnyResAtlas> = {
  readonly [k: string]: ShellNamespaceRef<RA>;
};

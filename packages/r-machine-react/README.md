...
| _This package_ | **[`@r-machine/react`](https://www.npmjs.com/package/@r-machine/react)** | **React integration. Install it in every project that renders React, Next.js included.**           |

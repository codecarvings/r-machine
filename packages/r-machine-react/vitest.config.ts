...
export default mergeConfig(
  ...
  defineProject({
    ...
    resolve: {
      alias: [
        { find: /^#r-machine\/react$/, replacement: path.resolve(import.meta.dirname, "./src/lib/index.ts") },
        { find: /^#r-machine\/react\/(.*)$/, replacement: path.resolve(import.meta.dirname, "./src/$1/index.ts") },

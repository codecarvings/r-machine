...
describe("lib barrel exports", () => {
  it("re-exports ReactStandardStrategy identical to the original", () => {
    expectTypeOf<ReactStandardStrategy<AnyResourceAtlas, AnyLocale, NamespaceMap<AnyResourceAtlas>>>().toEqualTypeOf<
      OriginalReactStandardStrategy<AnyResourceAtlas, AnyLocale, NamespaceMap<AnyResourceAtlas>>
    >();
  });
});

...
| **Mono shell** | [`shell/lib/fmt`](src/r-machine/pub/shell/lib/fmt.ts) | Per-locale `Intl` formatters — USD vs EUR currency, number grouping, pluralization, name collation. |
